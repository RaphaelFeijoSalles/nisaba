      ...
      <section className="onboarding-content">
        ...
        <div className="onboarding-card">
          ...
          {step === 2 && <form className="step-content" onSubmit={finish}>
            ...
            <div className="privacy-note"><span aria-hidden="true">i</span><p><strong>Você mantém o controle.</strong> Nesta versão, nenhuma informação é enviada a um servidor.</p></div>
            {error && <p className="form-error" role="alert">{error}</p>}
          ...
          {step === 3 && <div className="step-content completion-state">
            <div className="completion-mark" aria-hidden="true">V</div><span className="step-kicker">CONFIGURAÇÃO CONCLUÍDA</span>
